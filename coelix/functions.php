...
if ( ! function_exists( 'coelix_setup' ) ) :
	...
	function coelix_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'coelix_custom_background_args', array(
...
function coelix_scripts() {
	wp_enqueue_style( 'coelix-style', get_stylesheet_uri() );
	wp_enqueue_style( 'coelix-main-style', get_template_directory_uri() . '/assets/main.css' );
	wp_enqueue_style( 'coelix-main-adaptive', get_template_directory_uri() . '/assets/adaptive.css' );
	wp_enqueue_style( 'coelix-main-fullpage-styles', 'https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/3.0.7/fullpage.min.css' );
	wp_enqueue_style( 'coelix-slick-styles', 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.css' );

	wp_enqueue_script( 'coelix-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'coelix-main-script', get_template_directory_uri() . '/assets/main.js', array(), '20151215', true );
	wp_enqueue_script( 'coelix-wow', 'https://cdnjs.cloudflare.com/ajax/libs/wow/1.1.2/wow.min.js', array(), '20151215', true );
	wp_enqueue_script( 'coelix-fullpage', 'https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/3.0.7/fullpage.min.js', array(), '20151215', true );
	...
	wp_enqueue_script( 'coelix-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
function service_register(){
	register_post_type('service', array(
		'labels'             => array(
			...
			'not_found_in_trash' => 'There is no Services in stash',
			'parent_item_colon'  => '',
			'menu_name'          => 'Services'
		  ),
		'public'             => true,
